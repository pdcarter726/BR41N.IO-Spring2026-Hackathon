...
def main():
    ...
    dataset["NEUTRAL"] = record_action("Neutral (Just sit still)", 20, sct)
    dataset["MOVE"] = record_action("Eyebrow Raise", 20, sct)
    dataset["ROTATE"] = record_action("Jaw Clench", 20, sct)
